    ...
    <>
      <Container>
        ...
        <section className="container mx-auto flex flex-col justify-between items-center gap-2 mb-20">
          <h1 className="max-md:text-2xl max-lg:text-3xl text-4xl font-bold">Browse our <span className="text-[#FB6D11]">Categories</span></h1>
        ...
        <h1 className="w-full text-center max-md:text-xl max-lg:text-2xl text-3xl font-bold mb-[8px] py-6">Browse our <span className="text-[#FB6D11]">Featured</span> Products</h1>
